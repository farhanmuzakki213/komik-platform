                    ...
                    @forelse($pendingComics as $comic)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition">
                            ...
                            <td class="px-6 py-4 text-right">
                                <button wire:click="loadComicPreview({{ $comic->id }})" class="bg-blue-50 text-blue-600 hover:bg-blue-100 dark:bg-blue-900/20 dark:text-blue-400 px-4 py-2 rounded-lg font-medium transition shadow-sm">Review</button>
                            </td>
                        </tr>
                    @empty
