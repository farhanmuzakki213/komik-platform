                    ...
                    <div>
                        ...
                        <form wire:submit="login">
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input wire:model="form.email" id="email" name="email" type="email" placeholder="Masukkan email Anda"
                        ...
                        <div class="mt-5">
                            <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                Belum punya akun kreator?
                                <a wire:navigate href="{{ route('register') }}"
                                    class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Daftar sekarang</a>
                            </p>
                        </div>
                    </div>
                </div>
