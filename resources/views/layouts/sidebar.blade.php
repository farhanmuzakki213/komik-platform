    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="{{ route('home') }}" wire:navigate>
            <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                  class="text-2xl font-black text-brand-500 tracking-tighter uppercase font-sans">
                WEBKOMIK
            </span>
            
            <span x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                  style="display: none;"
                  class="text-3xl font-black text-brand-500 tracking-tighter uppercase font-sans">
                W
            </span>
        </a>
    </div>
